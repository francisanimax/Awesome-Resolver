...
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 23 | ❌ | ❌ |
...
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 170 | ✅ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 193 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 200 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 263 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 642 | ✅ | ❌ |
