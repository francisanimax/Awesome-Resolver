...
Last Updated: `2025-11-12 01:52:14 UTC`
...
| Google | `standard` | `8.8.8.8` | ✅ | 25 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 26 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 115 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 132 | ❌ | ❌ |
...
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 378 | ❌ | ❌ |
