...
Last Updated: `2025-11-13 04:29:04 UTC`
...
| Cloudflare (Secondary) | `standard` | `1.0.0.1` | ✅ | 5 | ❌ | ❌ |
...
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 98 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 129 | ❌ | ❌ |
...
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 272 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 820 | ✅ | ❌ |
