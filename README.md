...
Last Updated: `2025-11-22 16:27:25 UTC`
...
| Cloudflare (Secondary) | `standard` | `1.0.0.1` | ✅ | 10 | ❌ | ❌ |
...
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 11 | ❌ | ❌ |
| Quad9 | `filtering` | `9.9.9.9` | ✅ | 11 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 12 | ❌ | ❌ |
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ✅ | 13 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 16 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 18 | ❌ | ❌ |
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 20 | ❌ | ❌ |
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 20 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 41 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 60 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 60 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 91 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 142 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 185 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 186 | ✅ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 204 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 212 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 382 | ❌ | ❌ |
