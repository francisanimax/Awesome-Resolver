...
Last Updated: `2025-11-23 16:27:30 UTC`
...
| Google | `standard` | `8.8.8.8` | ✅ | 10 | ❌ | ❌ |
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ✅ | 10 | ❌ | ❌ |
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 11 | ❌ | ✅ |
...
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 21 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 23 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 24 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 88 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 144 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 187 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 187 | ✅ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 192 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 199 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 556 | ❌ | ❌ |
