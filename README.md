...
Last Updated: `2025-11-30 08:28:32 UTC`
...
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 14 | ❌ | ❌ |
...
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 83 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 115 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 124 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 164 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 166 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 237 | ✅ | ❌ |
