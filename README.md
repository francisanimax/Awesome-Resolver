...
Last Updated: `2025-11-23 04:35:24 UTC`
...
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 18 | ❌ | ❌ |
...
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 23 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 24 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 26 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 26 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 32 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 34 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 129 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 129 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 169 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 172 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 181 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 183 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 184 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 356 | ❌ | ❌ |
