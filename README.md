...
Last Updated: `2025-11-24 08:34:51 UTC`
...
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 62 | ❌ | ✅ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 104 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 129 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 170 | ❌ | ❌ |
...
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 184 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 372 | ❌ | ❌ |
