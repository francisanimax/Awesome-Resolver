...
Last Updated: `2025-11-26 20:26:12 UTC`
...
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 39 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 54 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 83 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 93 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 110 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 130 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 141 | ❌ | ❌ |
