...
Last Updated: `2025-11-16 08:28:35 UTC`
...
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 6 | ❌ | ❌ |
...
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 8 | ❌ | ❌ |
| Control D (Unfiltered) | `standard` | `76.76.2.0` | ✅ | 8 | ❌ | ❌ |
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ✅ | 8 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 9 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 11 | ❌ | ❌ |
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 12 | ❌ | ❌ |
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 31 | ❌ | ❌ |
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 34 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 56 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 85 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 111 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 132 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 134 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 139 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 149 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 150 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 216 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 378 | ✅ | ❌ |
