...
Last Updated: `2025-11-13 08:32:03 UTC`
...
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 7 | ❌ | ❌ |
...
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 17 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 20 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 55 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 81 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 88 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 132 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 133 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 152 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 152 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 219 | ✅ | ❌ |
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 255 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 389 | ✅ | ❌ |
