...
Last Updated: `2025-11-14 01:52:56 UTC`
...
| Neustar | `standard` | `156.154.70.1` | ✅ | 3 | ❌ | ❌ |
...
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 18 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 18 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 21 | ❌ | ❌ |
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 21 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 39 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 155 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 157 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 171 | ✅ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 195 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 195 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 197 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 203 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 222 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 254 | ❌ | ❌ |
