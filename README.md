...
Last Updated: `2025-11-12 04:28:47 UTC`
...
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 15 | ❌ | ❌ |
...
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 21 | ❌ | ✅ |
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 22 | ❌ | ✅ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 25 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 26 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 27 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 106 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 127 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 184 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 184 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 184 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 187 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 235 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 236 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 387 | ❌ | ❌ |
