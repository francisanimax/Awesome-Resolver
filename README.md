...
Last Updated: `2025-11-26 08:33:21 UTC`
...
| Cloudflare | `standard` | `1.1.1.1` | ✅ | 13 | ❌ | ❌ |
...
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 15 | ❌ | ❌ |
...
| Google | `standard` | `8.8.8.8` | ✅ | 19 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 19 | ❌ | ❌ |
| Control D (Unfiltered) | `standard` | `76.76.2.0` | ✅ | 19 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 20 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 20 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 22 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 115 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 165 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 171 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 198 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 199 | ✅ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 283 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 355 | ❌ | ❌ |
