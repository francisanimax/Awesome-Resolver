...
Last Updated: `2025-11-20 16:31:48 UTC`
...
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 12 | ❌ | ✅ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 16 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 17 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 18 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 19 | ❌ | ❌ |
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 19 | ❌ | ❌ |
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 22 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 23 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 27 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 109 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 142 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 182 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 187 | ✅ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 199 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 200 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 442 | ❌ | ❌ |
