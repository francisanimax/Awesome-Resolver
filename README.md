...
Last Updated: `2025-11-22 01:47:34 UTC`
...
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 12 | ❌ | ✅ |
...
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 59 | ❌ | ❌ |
...
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 201 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 230 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 394 | ❌ | ❌ |
