...
Last Updated: `2025-11-13 20:27:19 UTC`
...
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 9 | ❌ | ✅ |
...
| Neustar | `standard` | `156.154.70.1` | ✅ | 21 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 25 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 81 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 135 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 137 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 177 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 177 | ✅ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 182 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 188 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 191 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 192 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 271 | ❌ | ❌ |
