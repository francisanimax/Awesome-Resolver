...
Last Updated: `2025-11-24 02:00:01 UTC`
...
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 17 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 18 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 91 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 142 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 161 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 181 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 186 | ✅ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 186 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 190 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 196 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 331 | ❌ | ❌ |
...
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ❌ | - | ❌ | ❌ |
