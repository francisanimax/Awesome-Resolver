...
Last Updated: `2025-11-13 01:54:03 UTC`
...
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 6 | ❌ | ✅ |
...
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 163 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 170 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 171 | ✅ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 197 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 199 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 203 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 204 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 205 | ❌ | ❌ |
