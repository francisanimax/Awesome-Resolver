...
Last Updated: `2025-11-24 16:27:57 UTC`
...
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 58 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 84 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 88 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 137 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 138 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 153 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 219 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 223 | ✅ | ❌ |
| Quad9 | `filtering` | `9.9.9.9` | ✅ | 336 | ❌ | ❌ |
