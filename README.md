...
Last Updated: `2025-11-29 04:28:33 UTC`
...
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 16 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 17 | ❌ | ❌ |
...
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 19 | ❌ | ❌ |
...
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 25 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 26 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 27 | ❌ | ❌ |
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 27 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 43 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 126 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 144 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 182 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 185 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 186 | ✅ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 199 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 224 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 465 | ❌ | ❌ |
