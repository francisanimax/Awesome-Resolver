...
Last Updated: `2025-11-16 20:24:45 UTC`
...
| Neustar | `standard` | `156.154.70.1` | ✅ | 6 | ❌ | ❌ |
...
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 23 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 36 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 154 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 157 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 168 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 169 | ✅ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 190 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 200 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 200 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 201 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 321 | ❌ | ❌ |
