...
| Verisign | `standard` | `64.6.64.6` | ✅ | 24 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 27 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 34 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 35 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 131 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 134 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 180 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 182 | ✅ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 182 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 185 | ✅ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 188 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 273 | ❌ | ❌ |
