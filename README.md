...
Last Updated: `2025-11-26 16:31:52 UTC`
...
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ✅ | 10 | ❌ | ❌ |
| Cloudflare (Secondary) | `standard` | `1.0.0.1` | ✅ | 11 | ❌ | ❌ |
...
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 14 | ❌ | ✅ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 14 | ❌ | ❌ |
| Control D (Unfiltered) | `standard` | `76.76.2.0` | ✅ | 14 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 15 | ❌ | ❌ |
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 16 | ❌ | ✅ |
| Cloudflare | `standard` | `1.1.1.1` | ✅ | 20 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 20 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 22 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 24 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 25 | ❌ | ❌ |
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 28 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 89 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 116 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 121 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 174 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 175 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 199 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 200 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 333 | ❌ | ❌ |
