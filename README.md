...
Last Updated: `2025-11-14 12:49:32 UTC`
...
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 9 | ❌ | ❌ |
...
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 220 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 268 | ❌ | ❌ |
