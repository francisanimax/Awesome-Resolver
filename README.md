...
Last Updated: `2025-11-29 08:30:21 UTC`

## 📊 Live DNS Status Table

| Server | Type | Address | Status | Speed (ms) | Ad-Block | Malware-Block |
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 5 | ❌ | ❌ |
...
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 72 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 89 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 138 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 150 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 187 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 219 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 405 | ✅ | ❌ |
