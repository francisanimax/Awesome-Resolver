...
Last Updated: `2025-11-26 12:52:43 UTC`
...
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 26 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 26 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 27 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 27 | ❌ | ❌ |
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 28 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 35 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 37 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 103 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 127 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 142 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 181 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 184 | ✅ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 184 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 185 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 272 | ❌ | ❌ |
