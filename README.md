...
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 14 | ❌ | ✅ |
...
| Google | `standard` | `8.8.8.8` | ✅ | 21 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 21 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 24 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 90 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 110 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 163 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 174 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 249 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 249 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 4777 | ❌ | ❌ |
