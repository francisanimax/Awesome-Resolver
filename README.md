...
Last Updated: `2025-11-18 04:29:09 UTC`
...
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 4 | ❌ | ❌ |
...
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 16 | ❌ | ❌ |
...
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 147 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 153 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 209 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 400 | ✅ | ❌ |
