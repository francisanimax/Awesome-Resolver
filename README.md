...
Last Updated: `2025-11-27 12:51:24 UTC`
...
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 14 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 15 | ❌ | ❌ |
| Cloudflare (Secondary) | `standard` | `1.0.0.1` | ✅ | 18 | ❌ | ❌ |
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 18 | ❌ | ❌ |
...
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 19 | ❌ | ❌ |
| Cloudflare | `standard` | `1.1.1.1` | ✅ | 20 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 23 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 24 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 26 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 26 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 26 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 101 | ❌ | ❌ |
| DNS0.eu | `filtering` | `193.110.81.0` | ✅ | 131 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 166 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 180 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 191 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 235 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 239 | ✅ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 361 | ❌ | ❌ |
...
| Control D (Unfiltered) | `standard` | `76.76.2.0` | ❌ | - | ❌ | ❌ |
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ❌ | - | ❌ | ❌ |
